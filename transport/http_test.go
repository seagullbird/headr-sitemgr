...
func TestNewHTTPHandler(t *testing.T) {
	...
	req.Header.Add("Authorization", "Bearer "+validAccessToken)
	...
	if resp.StatusCode != http.StatusOK {
		t.Errorf("Unexpected status code: %d\n Status code should be %d", resp.StatusCode, http.StatusOK)
	}
