...
func (c *sitemgrClient) NewSite(ctx context.Context, in *NewSiteRequest, opts ...grpc.CallOption) (*NewSiteReply, error) {
...
func _Sitemgr_NewSite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SitemgrServer).NewSite(ctx, req.(*NewSiteRequest))
	}
...
var fileDescriptor0 = []byte{
	...
	0xe0, 0x0c, 0x82, 0x70, 0x84, 0xa4, 0xb8, 0x38, 0x40, 0xfa, 0xf3, 0x12, 0x73, 0x53, 0x25, 0x98,
	0xc0, 0x12, 0x70, 0xbe, 0x92, 0x02, 0x17, 0x0f, 0xdc, 0x8c, 0x82, 0x9c, 0x4a, 0x21, 0x01, 0x2e,
	0xe6, 0xd4, 0xa2, 0x22, 0xa8, 0x7e, 0x10, 0xd3, 0xc8, 0x86, 0x8b, 0x3d, 0x18, 0x62, 0xbb, 0x90,
	0x21, 0x17, 0x3b, 0x54, 0xb1, 0x90, 0x90, 0x5e, 0x41, 0x92, 0x1e, 0xaa, 0xed, 0x52, 0x02, 0x28,
	0x62, 0x05, 0x39, 0x95, 0x4a, 0x0c, 0x49, 0x6c, 0x60, 0xe7, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff,
	0xff, 0x13, 0x5b, 0x27, 0x25, 0xc2, 0x00, 0x00, 0x00,
}
