...
func (m *MockService) GetAbout(arg0 context.Context, arg1 uint) (string, error) {
	ret := m.ctrl.Call(m, "GetAbout", arg0, arg1)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockServiceMockRecorder) GetAbout(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAbout", reflect.TypeOf((*MockService)(nil).GetAbout), arg0, arg1)
}
